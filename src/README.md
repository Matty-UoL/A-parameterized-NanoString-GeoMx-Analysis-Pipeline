...
| 6 | `6_Differential_Expression_Visualisation.qmd` | Visualize and compare outputs from `5_Differential_Expression_Calculation.qmd`, then inspect selected methods and contrasts before enrichment. | `Outputs/6_DE_Vis/` comparison tables, figures, selected-method panels, and output list. |
